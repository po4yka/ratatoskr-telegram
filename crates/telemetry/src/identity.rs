...
///
/// ONE identity for both binaries. Observability and wire identity read the same constant on
/// purpose, so they cannot drift.
pub const SERVICE_NAME: &str = "ratatoskr-telegram";
...
/// | `ratatoskr.runtime_role` | `webhook` \| `dispatcher` |
///
